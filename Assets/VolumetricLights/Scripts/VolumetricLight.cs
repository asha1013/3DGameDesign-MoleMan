...
#pragma warning restore UDR0001 // Domain Reload Analyzer
        ...
        private LightSettings runtimeSettings = null;

        public bool scaleWithObjectScale => m_ScaleWithObjectScale;
        
        public LightSettings settings => Application.isPlaying ? playmodeSettings : (m_LightProfile == null ? localSettings : m_LightProfile.settings);
        private LightSettings playmodeSettings
        {
            get
            {
                if(runtimeSettings == null)
                    runtimeSettings = new LightSettings((m_LightProfile == null ? localSettings : m_LightProfile.settings));
