...
namespace Sparrow.VolumetricLight
{
    ...
    public class LightVolume : MonoBehaviour
    {
        ...
        private static readonly int DepthOverride = Shader.PropertyToID("_DepthOverride");
        ...
        public void SendValuesToMaterial()
        {
            ...
            if (urp)
            {
                propertyBlock.SetInt(DepthOverride, urp.supportsCameraDepthTexture ? 0 : 1);
            } else
            {
                propertyBlock.SetInt(DepthOverride, 0);
            }
